$ "c:\Program Files\Java\jdk1.7.0_79\bin\jarsigner.exe" -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore behawk.keystore android-release-unsigned.apk behawk

"c:\users\misha\AppData\Local\Android\sdk\build-tools\23.0.0\zipalign.exe" -v 4 android-release-unsigned.apk behawk.apk
