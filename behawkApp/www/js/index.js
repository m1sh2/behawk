...
var app = angular.module('BE', ['ngRoute','LocalStorageModule','chart.js','ionic','BE.controllers']);
app.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.buyers', {
    url: '/buyers',
    templateUrl: 'templates/buyers.html',
...
// }])
.run(['$window', '$rootScope', '$ionicPlatform', function($window, $rootScope, $ionicPlatform) {
...
angular.module('BE.controllers', []).controller('topCtrl', function($scope, $location, $route, Shops) {
	$scope._txt = _txt;
	$scope.lng = lng;
...
}).controller('ProductsCtrl', function ($scope, localStorageService, Shops) {
	var ls = localStorageService;
	$scope._txt = _txt;
	$scope.lng = lng;
	$scope.prods = [];
...
}).controller('CategoriesCtrl', function ($scope, localStorageService, Shops) {
	var ls = localStorageService;
	$scope._txt = _txt;
	$scope.lng = lng;
	$scope.shops = Shops.getShops();
...
}).controller('OrdersCtrl', function ($scope, localStorageService, Shops) {
	var ls = localStorageService;
	$scope._txt = _txt;
	$scope.lng = lng;
	$scope.shops = Shops.getShops();
...
}).controller('BuyersCtrl', function ($scope, localStorageService, Shops) {
	var ls = localStorageService;
	$scope._txt = _txt;
	$scope.lng = lng;
	$scope.shops = Shops.getShops();
...
}).controller('SettingsCtrl', function ($scope, localStorageService, $route, Shops, $window) {
	var ls = localStorageService;
	$scope._txt = _txt;
	$scope.lng = lng;
	$scope.settingsForm = {};
